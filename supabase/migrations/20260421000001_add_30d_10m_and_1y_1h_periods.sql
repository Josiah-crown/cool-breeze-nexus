-- ========================================
-- ADD PERIODS FOR SLIDER BUFFERS
-- Date: April 21, 2026
--
-- Adds:
-- - 30d_10m: 30 days @ 10-minute averages (buffer for 7d view)
-- - 1y_1h:   1 year  @ 1-hour averages (buffer for 30d view)
--
-- Point counts (approx):
-- - 30d_10m: 4320
-- - 1y_1h:   8760
...
BEGIN
  CASE p_period
    ...
    WHEN '7d_3m' THEN
      ...
      v_interval_minutes := 3;
    WHEN '7d' THEN
      v_start_time := NOW() - INTERVAL '7 days';
      v_interval_minutes := 10;
    WHEN '30d_10m' THEN
