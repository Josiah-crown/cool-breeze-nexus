-- Site ERF plan image + building wireframes (v1)
-- Date: 2026-05-06
--
-- Goals:
-- - One ERF image per Site (upload + view)
-- - Buildings can be drawn/placed on the ERF as rectangles (wireframes)

-- 1) ERF asset per site
...
-- 2) Building wireframe rectangles on ERF
