  ...
  return (
    <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      <Button 
        ...
        size="icon"
        onClick={onClose}
        className="fixed top-4 right-4 z-[60] w-14 h-14 rounded-full bg-accent/90 hover:bg-accent text-accent-foreground border-2 border-accent shadow-lg hover:scale-110 transition-all"
      >
        <X className="h-8 w-8" />
      </Button>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[70%_30%] gap-6">
              <div className="relative flex justify-center items-start">
                ...
                {/* Notification Toggle - Compact Bottom Right */}
                  ...
                  <TooltipProvider delayDuration={0}>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <div 
                          className={cn(
                            "flex items-center gap-1.5 bg-card/90 backdrop-blur-sm border-2 rounded-md px-2 py-1.5 hover:bg-card transition-all cursor-pointer shadow-md",
                          ...
                          onClick={async (e) => {
                            ...
                            try {
                              ...
                              toast({
                                title: 'Error',
                                description: 'Please run the migration first',
                                variant: 'destructive',
                              });
                            }
                          }}
                            ...
                            onCheckedChange={async (checked) => {
                              try {
                                ...
                                if (!error) {
                                  ...
                                  window.location.reload();
                                } else if (error.message?.includes('notifications_enabled') || error.message?.includes('column')) {
                                  toast({
                                    title: 'Migration Required',
                                    description: 'Please run the migration first',
                                    variant: 'destructive',
