  ...
  return (
    <Card className="bg-card border-[3px] border-accent">
      ...
      <CardContent className="p-3">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 xl:divide-x xl:divide-green-500/30">
          {/* LEFT COLUMN */}
              ...
              <div className="grid grid-cols-[1fr_80px_80px] gap-2 items-end">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="h-8 text-sm border border-foreground/30 bg-accent/10 px-2"
                  />
                </div>
                <div>
            ...
            <div className="grid grid-cols-[1fr_80px_80px] gap-2 items-end">
              ...
              <div>
                ...
                <Input
                  ...
                  value="0"
                  disabled
                  className="h-8 text-sm border border-foreground/30 bg-muted/20 px-2 text-muted-foreground"
                />
              </div>
              <div>
                <p className="text-[10px] text-muted-foreground mb-0.5">After (min)</p>
    ...
    <div className="space-y-3 pt-4 mt-4 border-t-2 border-green-500/30">
      <div className="flex items-center gap-2 text-xs font-semibold text-foreground uppercase">
      ...
      {/* Reminder Interval */}
      <div className="bg-accent/5 border-2 border-border rounded-lg p-3 space-y-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Input
              ...
              className="h-8 w-16 text-sm border border-foreground/30 bg-white px-2 text-center"
            />
