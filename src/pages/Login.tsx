      ...
      <Card className="w-full max-w-md border-primary bg-gray-200">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative hud-card border-[8px] border-primary/70 group">
              <div className="absolute inset-0 bg-accent/40 group-hover:bg-accent transition-all hud-card" />
              <div className="absolute inset-[2px] hud-card border-[5px] border-primary/70 pointer-events-none z-10" />
              <Button 
                type="submit" 
                className="w-full border-0 relative z-20 bg-transparent text-black hover:scale-[1.02] transition-all" 
